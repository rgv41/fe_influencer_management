      ...
      <Container>
        <Row>
          <Col md={6} style={leftColStyle}>
            <h1>Perluas Jangkauan Brand Anda dengan Starpowers</h1>
            ...
            <div>
              <Link to="/brand/formlogin" className="btn" style={buttonStyle('login')}>
                Login
              </Link>
              <Link to="/brand/signup" className="btn" style={buttonStyle('register')}>
                Register
              </Link>
            </div>
          </Col>
...
export default StartBrandLogin;